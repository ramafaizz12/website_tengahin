  ...
  return (
    <>
      <Layout
        ...
        breadcrumbTitle={
          <>
            Berita & <span>Pemberitahuan</span>
          </>
        }
      >
                          ...
                          <div className="col-12">
                            <div className="blog-item">
                              <div className="blog-content">
                                ...
                                <p>
                                  ChatGPT is a useful tool that can make your
                                  life easier when used appropriately. If you're
                                  going to use it, we recommend using it to
                                  assist your work instead of relying on it
                                  entirely. For a risk-free alternative,{" "}
                                </p>
                              </div>
