              ...
              <div className="col-lg-12">
                ...
                >
                  ...
                  <div className="work-content">
                    ...
                    <p>
                      Dex.ai is an advanced AI system that leverages
                      cutting-edge technologies and the latest Google data to
                      provide accurate responses to every request. With its vast
                      knowledge base and powerful algorithms,{" "}
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div className="work-content">
                    ...
                    <p>
                      Are you struggling to stay on top of all your business
                      tasks and responsibilities? Do you find yourself bogged
                      down by administrative work and unable to focus on your
                      core business activities? If so,
                    </p>
                  </div>
                </div>
                <div
