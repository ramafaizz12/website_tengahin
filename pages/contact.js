      ...
      >
        <div>
                ...
                <div className="row justify-content-center">
                  <div className="col-lg-4 col-md-6">
                    <div className="contact-info-item">
                      ...
                      <div className="content">
                        <h2 className="title">Kantor Pusat</h2>
                        <p>
                          Ruko Victorian Bintaro, Jl. Bintaro Utama 3A, Pd.
                          Karya, Kec. Pd. Aren,
                          <br /> Kota Tangerang Selatan, Banten 15225
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="contact-info-item">
                      ...
                      <div className="content">
                        <h2 className="title">Email Kami</h2>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="contact-form-wrap">
                    <h2 className="title">
                      Kalian punya <span>pertanyaan kontak kami</span>
                    </h2>
                    <div className="row">
          ...
          <div className="contact-map">
            <iframe
              src="https://maps.google.com/maps?q=-6.269316232797338, 106.7392471095945&hl=en&z=16&amp&output=embed"
              allowFullScreen
              loading="lazy"
            />
          </div>
