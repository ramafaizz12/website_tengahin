            ...
            <div className="container">
                ...
                <div className="row justify-content-center">
                  <div className="col-lg-4 col-sm-6">
                    <div className="footer-features-item">
                      ...
                      <div className="content">
                        <h4 className="title">Varantara Asset Management</h4>
                        <Link href="/contact">
                          Jelajahi Asset
                  ...
                  <div className="col-lg-4 col-sm-6">
                    <div className="footer-features-item">
                      ...
                      <div className="content">
                        <h4 className="title">Varantara Asuransi</h4>
                        <Link href="/contact">
                          Jelajahi Asuransi
                          <i className="fal fa-arrow-right" />
                        </Link>
              ...
              <div className="footer-widget-wrap">
                <div className="row row-cols-1 row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2">
                  ...
                  <div className="col">
                    <div className="footer-widget">
                      <h4 className="fw-title-two">Butuh bantuan ?</h4>
              ...
              <div className="row">
                <div className="col-lg-8">
                  <div className="copyright-text">
                    <p>
                      Copyright © {new Date().getFullYear()} Varantara All
                      rights reserved.
                    </p>
                  </div>
                </div>
